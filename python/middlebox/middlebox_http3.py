...
import wsproto.events # type: ignore
...
class HttpRequestHandler:
    ...
    async def run_asgi(self, app: AsgiApplication) -> None: # type: ignore
    ...
    async def request_handler(self):
        ...
        try:
            ...
            match(path):
                case '/prover-key':
                    # print("Sending prover key . . .")
                    status_code = 200
                    content = open("files/provKey.bin", "rb").read()
...
if __name__ == "__main__":
    ...
    print("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
    print("~~~~~~~~~~~     Starting Middlebox HTTP/3 - Listening on 0.0.0.0:5001     ~~~~~~~~~~~")
    print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n")

    defaults = QuicConfiguration(is_client=False)

    parser = argparse.ArgumentParser(description="Middlebox HTTP/3")
    parser.add_argument(
        "app",
        type=str,
        nargs="?",
