...
def run_looped_tests_string(circuit, num):
    ...
    #     (out, mem, cpu_time) = trackRun_cputime((f"java -Xmx6G -cp ../xjsnark_decompiled/backend_bin_mod/:../xjsnark_decompiled/xjsnark_bin/ xjsnark.PolicyCheck.{circuit}_Match run ../Tests/client_params_match.txt 0000d4d7508a089d5c0b8170dc69a659518c625b6a224c7a9894d35054ff run_mat_{str(i)} 1 300 {str(i)}").split(), "", [start_time, 0])
    #     with open(pathj, 'a') as file:
    #         file.write(str(cpu_time) + '\n')
    #     print("Tot CPU Time: ",cpu_time)
    ...
    (out, mem, cpu_time) = trackRun_cputime((f"java -Xmx6G -cp ../xjsnark_decompiled/backend_bin_mod/:../xjsnark_decompiled/xjsnark_bin/ xjsnark.PolicyCheck.{circuit}_Encryption run ../Tests/client_params.txt 0000d4d7508a089d5c0b8170dc69a659518c625b6a224c7a9894d35054ff run_enc 1 300 100").split(), "", [start_time, 0])
    with open(pathj, 'a') as file:
        file.write(str(cpu_time) + '\n')
    print("Tot CPU Time: ",cpu_time)
    ...
    (out, mem, cpu_time) = trackRun_cputime((f'../libsnark/build/libsnark/jsnark_interface/run_zkmb files/{circuit}_Encryption.arith files/{circuit}_Encryption_run_enc1.in prove run_enc 1').split(), "", [time.time(), 0])
    with open(pathlp, 'a') as file:
        file.write(str(cpu_time) + '\n')
    ...
    (out, mem, cpu_time) = trackRun_cputime((f'../libsnark/build/libsnark/jsnark_interface/run_zkmb files/{circuit}_Encryption.arith files/{circuit}_Encryption_run_enc1.in verify files/proofrun_enc1.bin').split(), "", [time.time(), 0])
    with open(pathlv, 'a') as file:
        file.write(str(cpu_time) + '\n')
    ...
    (out, mem, cpu_time) = trackRun_cputime((f"java -Xmx6G -cp ../xjsnark_decompiled/backend_bin_mod/:../xjsnark_decompiled/xjsnark_bin/ xjsnark.PolicyCheck.{circuit}_Match run ../Tests/client_params_match.txt 0000d4d7508a089d5c0b8170dc69a659518c625b6a224c7a9894d35054ff run_mat 1 300 100").split(), "", [start_time, 0])
    with open(pathj, 'a') as file:
        file.write(str(cpu_time) + '\n')
    print("Tot CPU Time: ",cpu_time)
    ...
    (out, mem, cpu_time) = trackRun_cputime((f'../libsnark/build/libsnark/jsnark_interface/run_zkmb files/{circuit}_Match.arith files/{circuit}_Match_run_mat1.in prove run_mat 1').split(), "", [time.time(), 0])
    with open(pathlp, 'a') as file:
        file.write(str(cpu_time) + '\n')
    ...
    (out, mem, cpu_time) = trackRun_cputime((f'../libsnark/build/libsnark/jsnark_interface/run_zkmb files/{circuit}_Match.arith files/{circuit}_Match_run_mat1.in verify files/proofrun_mat1.bin').split(), "", [time.time(), 0])
    with open(pathlv, 'a') as file:
        file.write(str(cpu_time) + '\n')
